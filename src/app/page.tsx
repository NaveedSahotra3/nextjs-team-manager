        ...
        <section className="container flex flex-col items-center justify-center gap-6 py-24 md:py-32">
          <div className="flex max-w-[980px] flex-col items-center gap-4 text-center">
            ...
            <p className="max-w-[750px] text-lg text-muted-foreground sm:text-xl">
              A production-ready team management platform with secure authentication, 
              role-based access control, and seamless team collaboration.
            </p>
        ...
        <section className="container py-12 md:py-16">
          <div className="grid gap-6 md:grid-cols-3">
            <Card>
              ...
              <CardContent>
                Industry-standard security practices with encrypted sessions and 
            ...
            <Card>
              ...
              <CardContent>
                Invite members via email, assign roles, and manage your team 
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Send secure invitation links to team members
                </CardDescription>
              </CardHeader>
              <CardContent>
                Token-based invitation system with expiration dates and 
        ...
        <section className="border-t bg-muted/50 py-12">
          <div className="container flex flex-col items-center gap-4 text-center">
            ...
            <p className="max-w-[600px] text-muted-foreground">
              Next.js 14, TypeScript, Neon Postgres, Drizzle ORM, Shadcn/ui, 
